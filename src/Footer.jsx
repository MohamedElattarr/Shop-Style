...
const Footer = () => {
  return (
    ...
    <div className="flex py-5 m-auto text-gray-800 text-sm flex-col items-center border-t ">
        ...
        <div className="my-5">© Copyright 2023. All Rights Reserved.Developed by <span className='text-gray-950'>Mohamed Elattar</span></div>
    </div>
</div>
    </div>
  )
